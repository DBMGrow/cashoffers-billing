...
- **See**: [DISC-001](discrepancies#disc-001-square-card-update-not-implemented)
...
- **See**: [DISC-003](discrepancies#disc-003-suspension-cron-is-stubbed)
...
- **See**: [DISC-005](discrepancies#disc-005-upgradedowngrade-user-config-not-implemented)
...
- **See**: [DISC-002](discrepancies#disc-002-homeuptick-tier-based-renewal-incomplete)

### TODO-005: Migrate to dotenvx
- **What**: Replace plain `.env` with encrypted dotenvx for better secrets management
- **See**: [dotenvx decision](../../business/decisions/dotenvx-todo)
...
- **See**: [DISC-008](discrepancies#disc-008-permission-strings-not-documented-locally)
