...
export interface HomeuptickSubscriptions {
  ...
  contacts_per_tier: Generated<number | null>
  created_at: Generated<Date | null>
  free_trial_contacts: Generated<number | null>
  free_trial_days: Generated<number | null>
  free_trial_ends: Date | null
  homeuptick_id: Generated<number>
  /**
   * Price per tier in cents
   */
  price_per_tier: Generated<number | null>
...
export interface Properties {
  ...
  /**
   * Indicates if the user wants to continue using the CashOffers system for this property. If the value is 0, then it means the user wants cash offers. 1 means the user does not want cash offers and we should close the property.
   */
  listed_mls: Generated<number>
  long: number | null
  lot: number | null
  neighborhood: string | null
...
export interface PropertiesDashRanking {
  address1: string
  address2: string | null
  agent_email: string
  agent_name: string | null
...
export interface PropertyOffersFull {
  agent_user_id: number
  amount: Decimal | null
  amount_initial: Decimal | null
  amount_net: Decimal | null
   ...
   */
  is_final_offer: Generated<number>
  is_property_unlocked: Generated<number | null>
  lender_user_id: number | null
  nickname: string
  notes_buyer: string | null
  notes_seller: string | null
...
export interface ShowingFeedbackDash {
  feedback: string | null
  feedback_id: Generated<number>
  property_id: number
  showing_id: number
...
export interface Showings {
  ...
  property_id: number
  sent_48hour_reminder: Generated<number>
  sent_dayof_reminder: Generated<number>
  sent_invites: Generated<number>
  sent_post_showing_feedback: Generated<number>
  sent_regular_rsvp: Generated<number>
  show_date: string
  showing_id: Generated<number>
  start_time: string
  time_changed: Generated<number>
  updated: Generated<Date>
}
...
export interface Users {
  ...
  role: Generated<string>
  show_welcome_tour: Generated<number>
  showings_info_read: Generated<number>
  slug: string | null
  state: string | null
  success_fee_pct: Decimal | null
  team_id: number | null
...
export interface UsersDash {
  ...
  showings_info_read: Generated<number | null>
  slug: string | null
  state: string | null
  success_fee_pct: Decimal | null
  team_id: number | null
...
export interface UserTours {
  tour_1: Generated<number>
  tour_2: Generated<number>
  tour_3: Generated<number>
  tour_4: Generated<number>
  tour_5: Generated<number>
  tour_6: Generated<number>
  user_id: number
}
...
export interface DB {
  ...
  Property_Offers_Full: PropertyOffersFull
  ...
  Showing_Feedback_Dash: ShowingFeedbackDash
