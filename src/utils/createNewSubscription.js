...
export default async function createNewSubscription(product, user, userWithEmailExists) {
  try {
    ...
    const signupFee = userWithEmailExists ? null : product?.dataValues?.price || null
