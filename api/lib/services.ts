...
import { billingLogRepository, transactionRepository, subscriptionRepository, whitelabelRepository } from '@api/lib/repositories'
...
const productionPaymentProvider = createSquarePaymentProvider(config, logger, 'production')
...
export const healthReportService = createHealthReportService(
